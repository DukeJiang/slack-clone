...
class Register extends React.Component {
  ...
  //handls form validation onSubmit
  isFormValid = () => {
    let errors = [];
    let error;
  ...
  //error will be displayed on submit
  ...
  /**
   @TODO : need to make send off a post request to backend creating a new user
   */
  handleSubmit = event => {
      ...
      <Grid textAlign="center" verticalAlign="middle" className="app">
        <Grid.Column style={{maxWidth: 600}}>
          <Header as="h2" icon color="teal" textAlign="center">
            <Icon name="comment alternate" color="teal" />
            Register for Belay
          </Header>
          <Form onSubmit={this.handleSubmit} size="large">
            <Segment stacked>
              ...
              placeholder="Confirm Password" onChange={this.handleChange} value={passwordConfirmation} 
              className={this.handleInputError(errors, "password")} type="password" />
